    ...
    return (
        <div className="header flex row p-1 gap-2 shadow-m">
            ...
            <div className="header__nav hf flex row gap-8 jc-c">
                <a href="/" className="flex a-c jc-c" >
                ...
                <a href="/books" className="flex a-c jc-c" >
                ...
                <div className="header-nav__item flex row gap-3 p-1" dist="about" title="about the developer">
                    <a href="/about" className="flex row">
            ...
            <div className="header__action hf flex row p-2 a-c jc-c gap-6 shadow-m">
                <div className="header-action-item flex a-c jc-c p-9" dist="Login"><a href="login">Login</a></div>
                <div className="header-action-item flex a-c jc-c p-9" dist="Register"><a href="login">Sign up</a></div>
            </div> 
            : 
            <div className="header__action hf flex row p-2 a-c jc-c gap-6 shadow-m">
